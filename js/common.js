(function(m, l) {
    ...
    var fa = {
        sopt: {
            ...
            taobao: ["\u6dd8\u5b9d", "http://arlier.work", "q", "pid:mm_26866744_3453767_13506237;search_type:auction;commend:all;at_topsearch:1;user_action:initiative;unid:21876;ie:gbk"]
        },
        init: function() {
        ...
        makeTip: function() {
            try {
                ...
                m("#wrap").addClass("noLB").prepend('<div id="lbtip"><a href="#" target="_blank" title="jingranluanma"><img src="images/110036_973.png" />fuck1<span>fuck2</span>fuck3<img src="images/143937_874.png" /></a></div>')
            }
        },
        makeSearch: function() {
            var l = this,
